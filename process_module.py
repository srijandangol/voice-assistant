...
def process(self,quest):
    ...
    if answer == "get time details":
        ...
        return("i have been created by ayush, bibek, bijay, srijan")
        ...
        return("Thanks. Further it is secret")

    elif answer == "107":
        return ("i am you virtual assistant")

    elif answer == "108":
        return ("i was created as a final project by ayush, bibek, bijay, srijan ")
